...
return {
	...
	["@chengxiang-card"] = "请打出点数之和为 %arg 的卡牌发动【称象】",
	["~caochong"] = "曹冲阵亡",

	-- 张儁乂
	["zhangjunyi"] = "张儁乂",
	["jueji"] = "绝汲",
	[":jueji"] = "你可跳过你的出牌阶段并和一名角色拼点.若你赢,你获得对方的拼点牌,并可立即再次与其拼点,如此反复,直到你没赢或不愿意继续拼点为止。",
	["@jueji"] = "绝汲",
	["$jueji"] = "何人能及？",
	["@jueji-pindian"] = "你可跳过你的出牌阶段并和一名角色拼点.若你赢,你获得对方的拼点牌,并可立即再次与其拼点,如此反复,直到你没赢或不愿意继续拼点为止.",
	["~zhangjunyi"] = "张儁乂阵亡",
	...
	["lianli-jink:jink"] = "你可以请求连理对象为你提供一张闪",
	...
	["#YitianSolace"] = "%from 发动了【倚天】，对 %to 的 %arg 点伤害减至 %arg2 点",
	["~yitianjian"] = "倚天剑阵亡",
