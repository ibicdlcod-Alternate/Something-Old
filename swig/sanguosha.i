...
public:
    ...
    void changePile(const char *name, bool add, int card_id);
...
public:
    ...
    JudgeStructPattern &operator=(const char *str);
...
public:
    ...
    typedef void (Room::*Callback)(ServerPlayer *, const char *);
    ...
    void toggleReadyCommand(ServerPlayer *player, const char *);
    void speakCommand(ServerPlayer *player, const char *arg);
    void trustCommand(ServerPlayer *player, const char *arg);
    void kickCommand(ServerPlayer *player, const char *arg);
    void surrenderCommand(ServerPlayer *player, const char *);
    void commonCommand(ServerPlayer *player, const char *arg);
    void addRobotCommand(ServerPlayer *player, const char *arg);
    void fillRobotsCommand(ServerPlayer *player, const char *arg);
    void chooseCommand(ServerPlayer *player, const char *general_name);
    void choose2Command(ServerPlayer *player, const char *general_name);
    ...
    void startTest(const char *to_test);
